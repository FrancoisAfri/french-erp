...
@section('content')
    <div class="row">
                    ...
                    @if (count($Categories) > 0)
						@foreach($Categories as $Category)
						 <tr id="categories-list">
						  <td nowrap>
								<button type="button" id="view_terms" class="btn btn-primary  btn-xs" onclick="postData({{$Category->id}}, 'terms');">Terms & Conditions</button>
        ...
        @include('quote.partials.add_new_category')
        @include('quote.partials.edit_category')
    </div>
@endsection
...
@section('page_script')
    <script>
		...
		{
			if (data == 'terms')
				location.href = "/quote/term-conditions/" + id;
			else if (data == 'edit')
				location.href = "/quote/cat_edit/" + id;
			else if (data == 'actdeac')
				location.href = "/quote/cat_active/" + id;
		}
        $(function () {
            var categiryID;
            //Tooltip
            ...
            $('#add-category').on('click', function() {
                postModuleForm('POST', '/quote/category', 'add-category-form');
            });

            $('#update-category').on('click', function() {
                postModuleForm('PATCH', '/quote/cat_edit/' + categiryID, 'edit-category-form');
            });
        });
    </script>
@endsection