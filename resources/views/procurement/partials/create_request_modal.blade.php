<div id="create-request-modal" class="modal modal-default fade">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="form-horizontal" method="POST" name="create-request-form">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Please Fill In Form</h4>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="add_request" class="btn btn-warning"><i
