<div id="add-fleet-modal" class="modal modal-default fade">
            ...
            <form class="form-horizontal" method="POST" name="edit-module-form">
               ...
               <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <button type="button" id="add-fleet-card" class="btn btn-warning"><i class="fa fa-cloud-upload"></i> Save</button>
                </div>
             </form>
            </div>
         </div>
