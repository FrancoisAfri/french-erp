<div id="edit-fire-extinghuisher-modal" class="modal modal-default fade">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
          
            <form class="form-horizontal" method="POST" name="edit-fireextinguishers-form">
                {{ csrf_field() }}
				{{ method_field('PATCH') }}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Edit Vehicle Fire Extinguishers </h4>
                </div>
				<div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
							...
							<input src="" type="image" id="fire_image" width="250"
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="update-fire-extinguishers" class="btn btn-warning"><i
