<div id="add-license-modal" class="modal modal-default fade">
        ...
        <div class="modal-content">
            <form class="form-horizontal" method="POST" name="edit-module-form">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add new License Type/Permit</h4>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="add-license-station" class="btn btn-warning"><i
