        ...
        <div class="modal-content">
            <form class="form-horizontal" method="POST" name="edit-module-form">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Edit Fleet Filling Station damage categories</h4>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="edit_station" class="btn btn-primary"><i class="fa fa-floppy-o"></i> Save
                    </button>
                </div>
            </form>
        </div>
