<div id="add-station-modal" class="modal modal-default fade">
        ...
        <div class="modal-content">
            <form class="form-horizontal" method="POST" name="edit-module-form">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add new Fleet Filling Station </h4>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="add-filling-station" class="btn btn-warning"><i
