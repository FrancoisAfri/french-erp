<div id="add-servicedetails-modal" class="modal modal-default fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" method="POST" name="add-servicedetails-form">
                {{ csrf_field() }}

                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"> Add New vehicle Details</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="date_serviced" name="date_serviced"
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="nxt_service_date" name="nxt_service_date"
                ...
                <button type="button" id="add_servicedetails" class="btn btn-warning"><i class="fa fa-cloud-upload"></i>
                        Save
                    </button>
                </div>
            </form>
