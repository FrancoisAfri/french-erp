<div id="add-vehicle_model-modal" class="modal modal-default fade">
        ...
        <div class="modal-content">
            <form class="form-horizontal" method="POST" name="edit-module-form">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add Vehicle Model for - {{$make->name}}</h4>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="add-vehicle_model" class="btn btn-warning"><i
