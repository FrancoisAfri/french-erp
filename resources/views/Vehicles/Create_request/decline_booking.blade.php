<div id="decline-booking-modal" class="modal modal-default fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" method="POST" name="decline-booking-form">
                {{ csrf_field() }}
                {{ method_field('PATCH') }}
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Decline Vehicle booking </h4>
                </div>
