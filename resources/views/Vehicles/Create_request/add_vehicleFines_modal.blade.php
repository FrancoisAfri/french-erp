<div id="add-fines-modal" class="modal modal-default fade">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="form-horizontal" method="POST" name="add-fines-form">
                {{ csrf_field() }}

                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"> Add new Vehicle Fines Details</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="date_of_fine" name="date_of_fine"
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="court_date" name="court_date"
                ...
                <button type="button" id="add_fines" class="btn btn-warning"><i class="fa fa-cloud-upload"></i>
                        Save
                    </button>
                </div>
            </form>
