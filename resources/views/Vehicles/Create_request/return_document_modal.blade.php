<div id="add-returndocument-modal" class="modal modal-default fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" method="POST" name="add-returndocument-form">
                {{ csrf_field() }}
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="returndocument" class="btn btn-warning"><i class="fa fa-cloud-upload"></i>
                        Upload
                    </button>
                </div>
            </form>
