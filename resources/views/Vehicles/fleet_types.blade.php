        ...
        <div class="col-md-12">
            <div class="box box-warning">
                <div class="box-header with-border">
                    <h3 class="box-title"> Add Vehicle Type(s)</h3>
                ...
                <!-- <form class="form-horizontal" method="POST" action="/hr/document"> -->
                    ...
                    <div class="box-body">
                        <table class="table table-bordered">
                            ...
                            @if (count($Vehiclemanagemnt) > 0)
                              @foreach ($Vehiclemanagemnt as $vehice)
                    ...
                    <div class="box-footer">
                     ...
                     <button type="button" id="cat_module" class="btn btn-warning pull-right" data-toggle="modal" data-target="#add-package-modal">Add new Vehicle Type </button>
                    </div>
             </div>
        </div>
   <!-- Include add new prime rate modal -->
        @include('Vehicles.partials.add_fleet_modal')
