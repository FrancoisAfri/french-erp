    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" id="report_form" method="POST" action="/meeting/search_results">
                    {{ csrf_field() }}

                    <div class="box-body">
						<div class="form-group">
                            <label for="meeting_title" class="col-sm-3 control-label">Meeting Title</label>
                            <div class="col-sm-9">
						...
						<div class="form-group">
                            <label for="meeting_date" class="col-sm-3 control-label">Meeting Date</label>
                            <div class="col-sm-9">
                                <div class="input-group">
								<div class="input-group-addon">
									<i class="fa fa-user"></i>
								</div>
								<input type="text" class="form-control daterangepicker" id="meeting_date" name="meeting_date" value="" placeholder="Select Meeting Date...">
                                </div>
                            </div>
                        </div>
                     </div>   
