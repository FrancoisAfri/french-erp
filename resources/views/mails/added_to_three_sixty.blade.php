...
<head>
    ...
    <title>{{ $company_name }} - Appraisal 360 Notification Email</title>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    Hi {{ $appraiser->first_name }},<br><br>
                                                    We would like to inform you that {{ $appraisedPerson->full_name }} has added you to {{ $appraisedPerson->gender ? ($appraisedPerson->gender == 1 ? 'his' : 'her') : 'their' }} Three-Sixty Appraisal Group for {{ $appraisalMonth }}.
                                                    <br>Please <a target="_blank" href="{{ $appraisalLink }}">click here</a> rate this person's performance for the month.
                                                </td>
                                            </tr>
                                            <tr>
