...
<head>
    ...
    <title>{{ $company_name }} - Vehicle Rejected</title>
                                            ...
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    Hi {{ $firstname . '' . $surname }},<br><br>
                                                     We would like to inform you that the new fleet loaded have been rejected. To view and update informations please <a target="_blank" href="{{ $fleetreject_url }}">click here.</a>
                                                </td>
                                            </tr>
