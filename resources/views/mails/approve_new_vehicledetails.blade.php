                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    ...
                                                    We would like to inform you that a new Vehicle has been Added and requires your approval. To view  and approve the new Vehicle please <a target="_blank" href="{{ $vehicleapproval_url }}">click here.</a>
                                                </td>
                                            </tr>
