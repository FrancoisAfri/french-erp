                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    ...
                                                    We would like to inform you that {{ $appraisedPerson->full_name }} has removed you from {{ $appraisedPerson->gender ? ($appraisedPerson->gender == 1 ? 'his' : 'her') : 'their' }} Three-Sixty Appraisal Group for {{ $appraisalMonth }}.
                                                </td>
                                            </tr>
                                            <tr>
