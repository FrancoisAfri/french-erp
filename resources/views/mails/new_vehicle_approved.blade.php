...
<head>
    ...
    <title>{{ $company_name }} - Vehicle Approved</title>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    Hi {{ $firstname . '' . $surname }},<br><br>
                                                     We would like to inform you that the new fleet loaded have been approved. To view and update informations please <a target="_blank" href="{{ $fleetapprove_url }}">click here.</a>
                                                </td>
                                            </tr>
