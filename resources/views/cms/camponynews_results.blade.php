                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align: middle;" nowrap>
                                        <div class="product-img">
                                            <img src="{{ (!empty($news->image)) ? Storage::disk('local')->url("CMS/images/$news->image") : 'http://placehold.it/60x50' }}"
                                                 alt="Product Image" width="56" height="50">
                                        </div>
                                    </td>
                                    <td style="vertical-align: middle;"
                                    ...
                                    <td style="vertical-align: middle;"
                                        nowrap>{{ (!empty( $news->expirydate)) ?  date(' d M Y', $news->expirydate) : ''}}</td>
                                    @endforeach
                                </tr>
