            ...
            <form class="form-horizontal" method="POST" name="edit-module-form">
               ...
               <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
					  ...
					  <div class="form-group gen-pub-field{{ $errors->has('gen_public_id') ? ' has-error' : '' }}">
                                <label for="product_id" class="col-sm-3 control-label">Product Type</label>
                                <div class="col-sm-9">
					 ...
					 <div class="form-group">
                        <label for="path" class="col-sm-3 control-label">Discount %</label>
                             <div class="col-sm-8">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="edit_package" class="btn btn-primary"><i class="fa fa-floppy-o"></i> Save</button>
                </div>
            </form>
            </div>
         </div>
