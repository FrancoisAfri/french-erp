<div id="add-folder-modal" class="modal modal-default fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" method="POST" name="add-folder-form">
                {{ csrf_field() }}
                        ...
                        <div class="form-group manual-field{{ $errors->has('division_level_' . $division_level->level) ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-8">
								<select id="{{ 'division_level_' . $division_level->level }}"
										...
										class="form-control"
										onchange="divDDOnChange(this, null, 'add-folder-modal')">
								</select>
                            </div>
                        </div>
                    @endforeach
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="add_folder" class="btn btn-warning"><i class="fa fa-cloud-upload"></i>
                        Save
                    </button>
                </div>
            </form>
