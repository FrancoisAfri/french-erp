...
<head>
    ...
    -->
    <link rel="stylesheet" href="/bower_components/AdminLTE/dist/css/skins/skin-{{ $skinColor }}.min.css">
    <!-- Custom styles -->
            ...
            @if (isset($breadcrumb) && count($breadcrumb) > 0)
                <ol class="breadcrumb">
                    @foreach($breadcrumb as $bc_item)
                        @if ($bc_item['active'] === 0)
                            <li><a href="{{ $bc_item['path'] }}">
                                    @if ($bc_item['is_module'] === 1)
                                        <i class="{{ $bc_item['icon'] }}"></i>
                                    @endif
                                    {{ $bc_item['title'] }}</a></li>
                        @else
                            <li class="active">
