        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title">Partners Search</h3>
                    <p>Enter search details:</p>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" id="report_form" method="POST" action="/partners/search_results">
                    {{ csrf_field() }}
                    <div class="box-body">
						<div class="form-group">
                            <label for="name" class="col-sm-3 control-label">Partner Type</label>
                            <div class="col-sm-9">
                                <label class="radio-inline" style="padding-left: 0px;"><input type="radio" id="rdo_provider" name="company_type" value="1" checked> Service Provider</label>
                                <label class="radio-inline"><input type="radio" id="rdo_school" name="company_type" value="2"> School</label>
                                <label class="radio-inline"><input type="radio" id="rdo_sponsor" name="company_type" value="3"> Sponsor</label>
                            </div>
                        </div>
						<div class="form-group">
