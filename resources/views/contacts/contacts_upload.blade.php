        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Contacts Upload</h3>
                ...
                <!-- Form Start -->
                <form name="upload company" class="form-horizontal" method="POST" action="/contacts_upload" enctype="multipart/form-data" required>
                    {{ csrf_field() }}
					...
					<div class="form-group">
                        <label for="path" class="col-sm-2 control-label">Upload Type</label>
                        <div class="col-sm-10">
                            <div class="input-group">
                                <div class="input-group-addon">
                                    <i class="fa fa-bullseye"></i>
                                </div>
                                <select class="form-control select2" style="width: 100%;" id="upload_type"
                                        name="upload_type" required>
                                    <option value="">*** Select Upload Type ***</option>
                                        <option value="1">Company</option>
                                        <option value="2">Company Rep</option>
                                </select>
                            </div>
                        </div>
                    </div>
