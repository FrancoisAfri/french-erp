						...
						<div class="form-group{{ $errors->has('cp_home_number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="cp_home_number" name="cp_home_number" value="{{ $company->cp_home_number }}" data-inputmask='"mask": "(999) 999-9999"' placeholder="Office Number" data-mask>
                                </div>
                            </div>
                        </div>
						<div class="form-group{{ $errors->has('fax_number') ? ' has-error' : '' }}">
							...
							<div class="col-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" id="fax_number" name="fax_number" value="{{ $company->fax_number }}" data-inputmask='"mask": "(999) 999-9999"' placeholder="Fax Number" data-mask>
								</div>
							</div>
						</div>
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" value="{{ $company->email }}" placeholder="Email Address">
                                </div>
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('phys_address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="phys_address" name="phys_address" value="{{ $company->phys_address }}" placeholder="Street Address">
                                </div>
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('phys_city') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="phys_city" name="phys_city" value="{{ $company->phys_city }}" placeholder="City">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="phys_province" name="phys_province" class="form-control">
                                        ...
                                        @foreach($provinces as $province)
                                            <option value="{{ $province->id }}" {{ ($company->phys_province == $province->id) ? ' selected' : '' }}>{{ $province->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group{{ $errors->has('phys_postal_code') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="phys_postal_code" name="phys_postal_code" value="{{ $company->phys_postal_code }}" placeholder="Postal Code">
                                </div>
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('registration_number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="registration_number" name="registration_number" value="{{ $company->registration_number }}" placeholder="Company Registration Number">
                                </div>
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('vat_number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="vat_number" name="vat_number" value="{{ $company->vat_number }}" placeholder="VAT Number">
                                </div>
                            </div>
                        </div>
                        <div class="form-group{{ $errors->has('tax_number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="tax_number" name="tax_number" value="{{ $company->tax_number }}" placeholder="Tax Number">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('bee_score') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="bee_score" name="bee_score" value="{{ $company->bee_score }}" placeholder="BEE Score">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="account_owners" name="account_owners" class="form-control select2">
                                        ...
                                        @foreach($employees as $employee)
                                            <option value="{{ $employee->id }}" {{($company->account_owners == $employee->id) ? ' selected' : '' }}>{{ $employee->first_name." ".$employee->surname }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
