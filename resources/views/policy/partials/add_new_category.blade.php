        ...
        <div class="modal-content">
            <form class="form-horizontal" method="POST" name="add-category-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" id="name" name="name" value="" placeholder="Entrez le nom" >
                            </div>
                        </div>
                    </div>
					<div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="add-category" class="btn btn-primary">Sauvegarder</button>
                </div>
            </form>
        </div>
        <!-- /.modal-content -->
