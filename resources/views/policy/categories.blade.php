...
@section('content')
    <div class="row">
        ...
        @include('policy.partials.add_new_category')
        @include('policy.partials.edit_category')
    </div>
@endsection
...
@section('page_script')
    <script>
		...
		{
			if (data == 'edit')
				location.href = "/policy/cat_edit/" + id;
			else if (data == 'actdeac')
				location.href = "/policy/cat_active/" + id;
		}
        $(function () {
            var categiryID;
            //Tooltip
            ...
            $('#edit-category-modal').on('show.bs.modal', function (e) {
                ...
                var WeightI = btnEdit.data('description');
                var modal = $(this);
                modal.find('#name').val(Name);
                modal.find('#description').val(WeightI);
            ...
            $('#add-category').on('click', function() {
                postModuleForm('POST', '/policy/category', 'add-category-form');
            });

            $('#update-category').on('click', function() {
                postModuleForm('PATCH', '/policy/cat_edit/' + categiryID, 'edit-category-form');
            });
        });
    </script>
@endsection