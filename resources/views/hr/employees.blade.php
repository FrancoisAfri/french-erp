        ...
        <div class="col-md-12">
           ...
           <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <form class="form-horizontal" method="POST" action="/hr/user_active">
                                ...
                                <div class="product-info">
                                    ...
                                    <!-- <span class="label {{ ($person->status === 1) ? 'label-success' : 'label-danger' }} pull-right">{{ $status_values[$person->status] }}</span> -->
                                     ...
                                     <span class="chkCheckbox pull-right ">
                                        <input type="hidden" class="checkbox selectall" id="selected_{{ $person->id }}_{{ $person->user_id }}" name="selected_{{ $person->user_id }}" value="0">

                                        <input type="checkbox" class="checkbox selectall" id="selected_{{ $person->id }}_{{ $person->user_id }}" name="selected_{{ $person->user_id }}"  value="1"  {{ $person->status === 1 ? 'checked ="checked"' : 0 }}> 
                                    </span> 
