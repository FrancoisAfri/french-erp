<div id="add-qualificationType-modal" class="modal modal-default fade">
            ...
            <form class="form-horizontal" method="POST" name="edit-module-form">
               ...
               <div class="modal-header">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="add_qualification" class="btn btn-primary"><i class="fa fa-floppy-o"></i> Add</button>
                </div>
            </form>
