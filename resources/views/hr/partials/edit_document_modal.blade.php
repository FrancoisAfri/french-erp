<div id="edit-document-modal" class="modal modal-default fade">
            ...
            <form class="form-horizontal" method="POST" name="edit-module-form">
               ...
               <div class="modal-header">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="edit_document" class="btn btn-primary"><i class="fa fa-floppy-o"></i> update</button>
                </div>
            </form>
