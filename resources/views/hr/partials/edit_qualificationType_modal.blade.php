<div id="edit-qualificationType-modal" class="modal modal-default fade">
            ...
            <form class="form-horizontal" method="POST" name="edit-module-form">
               ...
               <div class="modal-header">
                 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <h4 class="modal-title">Edit New Qualification</h4>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="edit_qualification" class="btn btn-primary"><i class="fa fa-floppy-o"></i> update</button>
                </div>
            </form>
