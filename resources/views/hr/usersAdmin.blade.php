                ...
                <div class="box-body">
                    <ul class="products-list product-list-in-box">
                        <div align="right">
                          ...
                          <!--  <input type="checkbox" id="checkallaccept" onclick="checkAllboxAccept()"> -->
                           </div>
                                ...
                                <div class="product-info">
                                    ...
                                    <!-- <span class="label {{ ($person->status === 1) ? 'label-success' : 'label-danger' }} pull-right">{{ $status_values[$person->status] }}</span> -->
                                     ...
                                     <span class="chkCheckbox pull-right ">
                                        ...
                                        <input type="checkbox" class="checkbox selectall" id="selected_{{ $person->id }}_{{ $person->user_id }}" name="selected_{{ $person->id }}_{{ $person->user_id }}_check[]" value="1"  {{ $person->status === 1 ? 'checked ="checked"' : 0 }}> 
                                    </span> 
