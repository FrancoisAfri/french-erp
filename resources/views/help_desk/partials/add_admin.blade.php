<div id="add-administrator-modal" class="modal modal-default fade">
               ...
               <div class="modal-header">
                ...
                <div class="modal-body">
					...
					<div class="form-group {{ $errors->has('leave_types_id') ? ' has-error' : '' }}">
                                <label for="leave_types_id" class="col-sm-2 control-label">Add Administrator </label>
                                <div class="col-sm-8">
                 ...
                 <div class="modal-footer">
                    ...
                    <button type="button" id="add_admin" class="btn btn-primary">Save</button>
                </div>
             </form>
            </div>
         </div>
