		...
		<div class="col-sm-12">
			<div class="box box-success">
				<div class="box-header with-border">
					<h3 class="box-title">JobCard History Number: {{$card->jobcard_number}}</h3>
				...
				<div class="box-body" style="max-height: 500px; overflow-y: scroll;">
					<table id="example2" class="table table-bordered table-hover">
						...
						<tbody>
							@if (count($card->JobCardHistory) > 0)
								@foreach ($card->JobCardHistory as $history)
									<tr>
				...
				<div class="box-footer">
					...
					<a href="{{ '/jobcard/jobcard_print/'.$card->id.''}}" class="btn btn-success pull-right" target="_blank">Print History</a>
                </div>
			</div>
		</div>
    </div>
